...
"""
    fetch_home_timeline(count::Int, seen_tweet_ids::Vector{String}, 
                       scraper::Scraper)::Vector{Any}

Retrieves the home timeline of a user.
"""
function fetch_home_timeline(count::Int, seen_tweet_ids::Vector{String}, 
                           scraper::Scraper)::Vector{Any}
...
Type for the home timeline response.
"""
struct HomeTimelineResponse
    data::Union{Nothing,Dict{String,Any}}
end

export fetch_home_timeline, HomeTimelineResponse
